...
function ISRestOnChairAction:animEvent(event, parameter)
...
function ISRestOnChairAction:readingStart()
...
function ISRestOnChairAction:reading()
    if not self.book then
        return
    end
...
function ISRestOnChairAction:readingStop()
    if not self.book then
        return
    end
...
function ISRestOnChairAction:readingPerform()
    if not self.book then
        return
    end
    self.character:setReading(false)
